...
function Dashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchData = async ()=>{
            try {
                const apiUrl = ("TURBOPACK compile-time value", "http://localhost:3000") || 'http://localhost:5000';
                // Fetch tasks
                const tasksRes = await fetch(`${apiUrl}/api/tasks/all`);
                const tasksData = await tasksRes.json();
                setTasks(tasksData.slice(0, 10)); // Show 10 most recent
                // Fetch stats
                const statsRes = await fetch(`${apiUrl}/api/tasks/stats/overview`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9005b502._.js.map